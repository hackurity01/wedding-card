      ...
      <div style={{ height: '1800px' }}>
        <div
          ...
          style={{
            ...
            opacity: computedValueWithKeyframe(scrollTop, 8800, 1400, { 0: 0, 30: 1, 65: 1, 100: 0 }, 'easeInOutQuad'),
        ...
        <div
          ...
          <div
            style={{
              color: 'white',
              opacity: computedValueWithKeyframe(scrollTop, 9500, 900, { 0: 0, 35: 1, 65: 1, 100: 0 }, 'easeInOutQuad'),
            }}>
            서로와의 평생을 약속하려 합니다
          </div>
        </div>
